...
#
"""Inventory management for .NET instrumentation tracking."""
...
class InventoryManager(BaseInventoryManager):
    """Manages .NET instrumentation inventory storage and retrieval."""

    FILE_NAME = "instrumentation.yaml"

    def __init__(self, inventory_dir: str = "ecosystem-registry/dotnet"):
        """
        Args:
