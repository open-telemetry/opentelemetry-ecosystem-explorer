...
class CollectorDatabaseWriter:
    ...
    def write_markdown(self, component_name: str, markdown_hash: str, content: str) -> bool:
        ...
        if not content.strip():
            # A handful of components (e.g. jaegerencodingextension) have a README
            # that is nothing but the autogenerated status section. Publishing the
            # empty remainder would give the detail page a README tab rendering
            # blank; returning False leaves markdown_hash unstamped so no tab shows.
