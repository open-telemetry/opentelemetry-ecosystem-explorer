  ...
  return (
    <section className="bg-background relative flex items-center justify-center overflow-hidden py-12">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, hsl(var(--otel-blue-hsl) / 0.08) 0%, hsl(var(--otel-orange-hsl) / 0.04) 30%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 px-6 text-center">
        ...
        <div
          ...
          style={{
            boxShadow: "0 0 60px hsl(var(--otel-blue-hsl) / 0.2)",
          }}
        >
