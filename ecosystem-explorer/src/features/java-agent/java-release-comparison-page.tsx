...
export function JavaReleaseComparisonPage() {
  ...
  const isInvalidComparison = useMemo(() => {
    ...
    // If either version is not found, it's an invalid/broken comparison
          ...
          <div className="animate-in fade-in space-y-12 duration-300">
            ...
            <div className="space-y-8">
              ...
              >
                <SegmentedTabList
                  tabs={[
                    { value: "changes", label: "Changes Summary" },
                    { value: "metrics", label: `All Metrics (${toVersion})` },
                  ]}
                  value={activeTab}
                />

                <TabsContent value="changes" className="mt-8 space-y-8">
                ...
                <TabsContent value="metrics" className="mt-8 space-y-8">
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
