...
export const FILTER_STYLES = {
  ...
  target: {
    javaagent: {
      active:
        "bg-orange-500/40 border-orange-400 text-orange-900 dark:text-orange-100 shadow-[0_0_15px_rgba(249,115,22,0.3)] ring-1 ring-orange-400/50",
      inactive:
        "bg-orange-500/5 border-orange-500/20 text-orange-700 dark:text-orange-400/70 hover:border-orange-500/50 hover:bg-orange-500/10",
    },
    library: {
      active:
        "bg-purple-500/40 border-purple-400 text-purple-900 dark:text-purple-100 shadow-[0_0_15px_rgba(168,85,247,0.3)] ring-1 ring-purple-400/50",
      inactive:
        "bg-purple-500/5 border-purple-500/20 text-purple-700 dark:text-purple-400/70 hover:border-purple-500/50 hover:bg-purple-500/10",
    },
  },
} as const;
