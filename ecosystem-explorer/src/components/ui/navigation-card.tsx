...
export function NavigationCard({ title, description, href, icon }: NavigationCardProps) {
  ...
  return (
    <Link to={href} className="group block h-full">
      <div className="border-border/60 bg-surface-card shadow-surface hover:border-primary/50 hover:bg-card hover:shadow-primary/15 relative h-full overflow-hidden rounded-lg border p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-surface-hover sm:p-8">
