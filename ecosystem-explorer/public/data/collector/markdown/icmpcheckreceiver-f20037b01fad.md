...
> **Note:** This receiver was renamed from `icmpcheckreceiver` to `icmp_check` to match the snake_case naming convention.
> The deprecated component type `icmpcheckreceiver` is still accepted as an alias and will log a deprecation warning.
